...
export namespace gameModel {
    ...
    export const currentVote = t.Object({
        ...
        proposalDeadline: t.Number(), // Timestamp when voting ends (20s)
    })
    ...
    export const gameRoom = t.Intersect([
        ...
        t.Object({
            ...
            phaseDeadline: t.Nullable(t.Number()), // Time to make proposal (90s)
    ...
    export const wsEvents = {
        ...
        gameUpdate: t.Object({
            ...
            game: t.Any(), // Client-safe game state
        }),
        
        proposalStarted: t.Object({
            type: t.Literal('proposal_started'),
            proponent: t.String(),
            deadline: t.Number(), // 90 seconds from now
        }),
        ...
        proposalSubmitted: t.Object({
            ...
            proponent: t.String(),
            proposedChefs: t.Array(t.String()),
            deadline: t.Number(), // 20 seconds from now
        }),
